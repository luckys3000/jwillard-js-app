let pokemonRepository = (function () {
	...
	function i(t) {
		'object' == typeof t && 'name' in t ? ((t.name = n(t.name)), e.push(t)) : console.log('Error: Pokemon is not correct');
	}
	function r() {
		return fetch(t)
			.then(function (e) {
	...
	function a(e) {
		return fetch(e.detailsUrl)
			...
			.then(function (t) {
				(e.imageUrl = t.sprites.other.home.front_default), (e.height = t.height), (e.types = t.types.map((e) => e.type.name)), (e.id = t.id);
			})
			.catch(function (e) {
				console.error(e);
			});
	...
	function l(e) {
		a(e).then(() => {
			...
			i.classList.add('btn', 'btn-primary', 'btn-block'), i.setAttribute('data-toggle', 'modal'), i.setAttribute('data-target', '#pokemonModal');
			let r = document.createElement('img');
			(r.src = e.imageUrl), (r.alt = e.name), r.classList.add('img-fluid', 'mb-2');
